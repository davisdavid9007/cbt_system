<?php
// functions.php - Tip Top Schools Utility Functions
...
function displayHeader($pageTitle = '') {
    $schoolName = defined('SCHOOL_NAME') ? SCHOOL_NAME : 'Tip Top Schools';
    ...
    <body>
        <div class="school-header">
            ...
            <div class="tagline">Excellence in Education & Technology</div>
        </div>
    ';
}
...
function displayCountdownTimer($seconds) {
    ...
    return sprintf("<div class='timer-display' style='font-size: 1.5em; font-weight: bold; text-align: center; padding: 15px; background: linear-gradient(135deg, %s, %s); color: white; border-radius: 10px; margin: 15px 0;'>
                    Time Remaining: %02d:%02d:%02d
                  </div>", 
                  $color_warning, $color_danger, $hours, $minutes, $seconds);
}
